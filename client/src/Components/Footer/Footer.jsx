...
>>>>>>> 935899aab19a0d3ab4b56ace3eaf040188cd4222
      </div>
...
>>>>>>> 935899aab19a0d3ab4b56ace3eaf040188cd4222
      ...
      <div className="contacts">
        <a href="https://maps.app.goo.gl/EWSsuCfKTZvQZBxCA" target="_blank" rel="noreferrer">
          <BsPinMapFill style={{ scale: "120%" }} />
          <span>NIT Raipur, Raipur, CG 492013</span>
        </a>

        <a href="mailto:info@icell.io" target="_blank" rel="noreferrer">
          <BsEnvelope style={{ scale: "120%" }} />
          <span>info@icell.io</span>
        </a>
      </div>
    </div>
    ...
    <div className="social-container">
      ...
      <div className="socials">
        {footerLinks.map((links, idx) => (
          <a key={idx} href={links.link} target="_blank" rel="noreferrer">
            <links.icon />
          </a>
        ))}
      </div>
