      ...
      <div className="maker__about">
        ...
        <div className="maker__about_content">
          ...
          <p>
            ...
            Technology Development Culture to promote mainly frugal innovations.
          </p>
          <p>
            {" "}
            It is set up to provide working ecosystem to prospective
            entrepreneurs of NIT Raipur. Once the raw and innovative ideas will
            start taking shapes, they will be incubated in a proper system of
